            ...
            <div className="flex flex-row items-center gap-6">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="" className="group">
                            <svg className="group-hover:scale-105 duration-150 ease-linear transition-all" xmlns="http://www.w3.org/2000/svg" width="29.5" height="29.5" viewBox="0 0 1000 1000">
            ...
            <div className="px-4 lg:px-20 mt-14 flex flex-col gap-18">
                ...
                <div className="flex items-center justify-center">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder=""
                        className="border-b border-black/20 dark:border-gray-400 py-1 focus:border-b focus:border-black dark:focus:border-white transition-colors focus:outline-none peer bg-inherit w-full"
                    />
                    <label
                        htmlFor="username"
                ...
                <button
                className="cursor-pointer group relative bg-black text-white dark:bg-white active:scale-85 dark:text-black font-semibold text-sm px-6 py-3 rounded-[5px] transition-all duration-200 ease-in-out shadow hover:shadow-lg w-40 h-12"
                >
