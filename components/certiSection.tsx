...
const CertiSection = () => {
  ...
  return (
    ...
    >
      <div
        ref={pinRef}
        className="relative lg:h-[100svh] lg:min-h-[48rem]"
      >
        <div className="mx-auto flex h-full max-w-[100rem] flex-col px-4 py-28 sm:px-6 sm:py-36 lg:px-8 lg:py-10">
          ...
          <div
            ...
            className="
              -mx-4 mt-5 overflow-x-auto px-4 pb-6
              [scrollbar-width:none]
              focus-visible:outline-2
              focus-visible:outline-offset-4
              focus-visible:outline-black
              sm:-mx-6 sm:px-6
              lg:-mx-8 lg:min-h-0 lg:flex-1 lg:overflow-visible lg:px-0 lg:pb-0
          ...
          >
            <div
              ...
              className="
                ...
                sm:gap-5
                lg:h-full lg:items-center lg:gap-5 lg:snap-none
            ...
            >
              {certificates.map((certificate, index) => (
                <article
                  ...
                  className="
                    ...
                    hover:shadow-[0_24px_56px_-40px_rgba(0,0,0,0.42)]
                    sm:w-[20rem]
                    lg:h-[23rem] lg:w-[18rem]
                    dark:border-white/10 dark:bg-[#111111]
                    dark:hover:border-white/20
                  "
                >
                  <div className="relative h-40 shrink-0 overflow-hidden border-b border-black/10 bg-neutral-200 sm:h-44 lg:h-36 dark:border-white/10 dark:bg-neutral-900">
                    <Image
                      src={certificate.image}
                      alt={`${certificate.title} certificate issued by ${certificate.issuer}`}
                      fill
                      sizes="(max-width: 640px) 78vw, (max-width: 1024px) 320px, 288px"
                      className="
                        object-cover
                    ...
                    <span className="absolute left-3.5 top-3.5 rounded-full border border-black/10 bg-white/90 px-2.5 py-1 font-mono text-[9px] text-black/65 backdrop-blur-md dark:border-white/10 dark:bg-black/80 dark:text-white/65">
                      {(index + 1).toString().padStart(2, '0')}
                    </span>
                  </div>

                  <div className="flex min-h-0 flex-1 flex-col p-4">
                    <div className="flex items-start justify-between gap-4 font-mono text-[8px] uppercase tracking-[0.14em] text-black/40 dark:text-white/40">
                    ...
                    <h3 className="mt-3 line-clamp-2 text-base font-semibold leading-[1.2] tracking-[-0.03em] text-black sm:text-lg dark:text-white">
                      {certificate.title}
                    </h3>

                    <p className="mt-2 line-clamp-2 text-[11px] leading-[1.6] text-black/50 dark:text-white/50">
                      {certificate.description}
                    </p>

                    <ul
                      className="mt-auto flex max-h-[3.5rem] flex-wrap gap-1.5 overflow-hidden pt-4"
                      ...
                      {certificate.skills.map((skill) => (
                        <li
                          ...
                          className="
                            ...
                            px-2 py-1 text-[8px] leading-none text-black/50
              ...
              <div
                aria-hidden="true"
                className="hidden h-[23rem] w-[6vw] shrink-0 lg:block"
              />
            </div>
          </div>

          <div className="mx-auto hidden w-full max-w-7xl shrink-0 lg:block">
            ...
            <div className="mt-2.5 flex justify-between font-mono text-[9px] uppercase tracking-[0.16em] text-black/35 dark:text-white/35">
              <span>01</span>
