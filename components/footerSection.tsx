...
const Footer = () => {
  return (
    <footer className="px-2 pb-2 sm:px-4 sm:pb-4 lg:px-6 lg:pb-6">
      <div className="mx-auto max-w-[96rem] overflow-hidden rounded-[2rem] bg-neutral-950 px-5 pb-6 pt-8 text-white sm:px-8 sm:pb-8 lg:rounded-[2.5rem] lg:px-12 lg:pt-10">
        <div className="flex items-center justify-between border-b border-white/15 pb-5 text-[10px] font-medium uppercase tracking-[0.18em] text-white/40">
        ...
        <div className="mt-7 flex flex-col gap-4 border-t border-white/15 pt-5 text-[10px] uppercase tracking-[0.12em] text-white/35 sm:flex-row sm:items-center sm:justify-between">
          <p>
